...
CT-SN-Nouvelle-proposition-commerciale
    ...
    # Connexion
    Open Browser    http://192.168.0.30/dolibarr/index.php    ${BROWSER}
    Input Text    //*[@id="username"]    ${login}
    Input Text    //*[@id="password"]    ${password}
    Click Button    //*[@id="login_line2"]/input
    # Vérifier que la page d'accueil s'ouvre
    Location Should Be    http://192.168.0.30/dolibarr/index.php?mainmenu=home
    ...
    Location Should Be    http://192.168.0.30/dolibarr/comm/index.php?mainmenu=commercial&leftmenu=
    ...
    Location Should Be    http://192.168.0.30/dolibarr/comm/propal/card.php?action=create&leftmenu=propals
    ...
    Location Should Be    http://192.168.0.30/dolibarr/index.php
    Close All Browsers
...
CT-SN-Nouvelle-demande-prix
    ...
    Location Should Be    http://192.168.0.30/dolibarr/supplier_proposal/card.php?action=create&leftmenu=supplier_proposals&idmenu=22
